...
exports.getPipCacheDir = getPipCacheDir;
exports.getUvCacheDir = getUvCacheDir;
exports.pruneUvCache = pruneUvCache;
exports.installMise = installMise;
exports.installPython = installPython;
exports.activatePython = activatePython;
...
function getCacheTagPrefix(inputCacheTag) {
    return (0, action_core_1.getCacheTagPrefix)(inputCacheTag, 'python');
}
async function getPythonVersion(inputVersion, workingDir) {
    if (inputVersion) {
        return inputVersion;
    }
